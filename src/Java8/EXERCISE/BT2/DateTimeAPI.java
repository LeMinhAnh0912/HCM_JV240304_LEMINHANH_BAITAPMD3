package src.Java8.EXERCISE.BT2;
...
public class DateTimeAPI {
    public static void main(String[] args) {
        ...
        int dayInMonth = YearMonth.of(today.getYear(), today.getMonth()).lengthOfMonth();
        System.out.println("Number of days in the current month: " + dayInMonth);
